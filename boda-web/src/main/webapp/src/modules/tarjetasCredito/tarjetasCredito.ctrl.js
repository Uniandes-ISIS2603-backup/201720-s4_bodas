(function (ng) {
    ...
    mod.controller('tarjetasCreditoCtrl', ['$scope', '$http', 'parejasContext', 'tarjetasCreditoContext', '$state', '$stateParams',
        function ($scope, $http, tarjetasCreditoContext, parejasContext, $state, $stateParams) {
                $scope.records = {};
